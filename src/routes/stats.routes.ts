...
router.get("/period", async (req, res) => {
  try {
    ...
    const startDate = parseDate(startDateStr as string | undefined, defaultStartDate);
    const endDate = parseDate(endDateStr as string | undefined, defaultEndDate);
