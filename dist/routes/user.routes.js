...
router.post('/', upload_1.default.single('profileImage'), handleMulterError, async (req, res) => {
    try {
        const { firstname, lastname, civilState, password, birthDate, gender, joinDate, country, birthCountry, baptismDate, baptismLocation, mobilePhone, homePhone, facebook, email, addressLine, city, birthCity, profession, churchId, age, personToContact, spouseFullName, minister, role, nif, groupeSanguin, isBaptized, groupId, sundayClassId } = req.body;
